 ...
 */
@WebServlet("/team/search_team")
public class SearchTeamByNameServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<TeamDetailDTO> listOfMatchInvitation = teamService.SearchTeamByString(input, lastTeamId);

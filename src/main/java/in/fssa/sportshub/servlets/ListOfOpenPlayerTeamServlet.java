 ...
 */
@WebServlet("/team/open_for_player")
public class ListOfOpenPlayerTeamServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<TeamDetailDTO> listOfMatchInvitation = teamService.getOpenForPlayerTeamList(pageSize, lastTeamId);

...
/**
 * Servlet implementation class CreateRequestResponseAcceptServlet
 */
@WebServlet("/invitation/accept")
public class CreateRequestResponseAcceptServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			requestResponseServ.accept(teamCaptainRelId, matchId);

			res.setStatus(200);
			res.setData("success");
			res.setMessage("Match request accepted successfully");
